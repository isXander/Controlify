...
public final class C2SNetworkApiImpl implements C2SNetworkApi {
    public static final C2SNetworkApiImpl INSTANCE = new C2SNetworkApiImpl();

    private final Map<ResourceLocation, FabricPacketWrapper<?>> packets = new HashMap<>();

    private C2SNetworkApiImpl() {
    }
