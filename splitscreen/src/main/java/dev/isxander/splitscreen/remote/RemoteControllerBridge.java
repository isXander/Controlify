package dev.isxander.splitscreen.remote;

import dev.isxander.splitscreen.ControllerBridge;
import dev.isxander.splitscreen.ipc.packets.controllerbound.play.ControllerboundEngineCustomPayloadPacket;
import dev.isxander.splitscreen.ipc.packets.controllerbound.play.ControllerboundGiveMeFocusIfForegroundPacket;
import dev.isxander.splitscreen.ipc.packets.controllerbound.play.ControllerboundServerDisconnectedPacket;
import dev.isxander.splitscreen.ipc.packets.controllerbound.play.ControllerboundSignalReadyPacket;
