...
public sealed interface Signal {
     ...
     * The data is expected to be tick-integrated deltas. They are not IMU samples.
     * @see SensorAccumulatorStage
     */
    record SensorData(long timeNanos, SensorType sensorType, float[] value) implements Signal {}
}
