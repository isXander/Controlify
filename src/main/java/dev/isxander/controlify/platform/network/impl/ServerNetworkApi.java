...
public final class ServerNetworkApi implements S2CNetworkApi {
    public static final ServerNetworkApi INSTANCE = new ServerNetworkApi();

    private final Map<ResourceLocation, FabricPacketWrapper<?>> packets = new HashMap<>();

    private ServerNetworkApi() {
    }
