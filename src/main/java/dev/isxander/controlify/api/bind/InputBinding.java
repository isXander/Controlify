 ...
 * It is bound to a impl {@link Input}, e.g. the A button.
 * Every tick, the input binding will update its state based on the impl input and then propagate to its outputs,
